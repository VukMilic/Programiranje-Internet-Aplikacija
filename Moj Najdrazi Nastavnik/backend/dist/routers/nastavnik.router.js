...
nasRouter.route('/sendCV').post(upload.single('selectedCV'), (req, res) => new nastavnik_controller_1.NastavnikController().sendCV(req, res));
...
nasRouter.route('/getSveZahteve').get((req, res) => new nastavnik_controller_1.NastavnikController().getSveZahteve(req, res));
